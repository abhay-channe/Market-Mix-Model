...
model_2 <- lm(formula = gmv ~ TotalInvestment + totalTV + totalDigital + 
                ...
                totalAffiliates + totalSEM + totalRadio + totalOther + Promotion + 
                totalunits + avgsla + product_analytic_verticalCameraAccessory + 
                product_analytic_verticalCameraBag + product_analytic_verticalCameraBatteryCharger + 
                ...
                product_analytic_verticalReflectorUmbrella + product_analytic_verticalStrap + 
                product_analytic_verticalTelescope + avgNPSScore + totalorder_payment_typePrepaid + 
...
model_3 <- lm(formula = gmv ~ TotalInvestment + totalTV + totalDigital + 
                totalSponsorship + totalContentMarketing + totalOnlineMarketing + 
                totalSEM + totalRadio + totalOther + Promotion + 
                totalunits + avgsla + product_analytic_verticalCameraAccessory + 
                product_analytic_verticalCameraBag + product_analytic_verticalCameraBatteryCharger + 
                product_analytic_verticalCameraEyeCup + product_analytic_verticalCameraHousing + 
                product_analytic_verticalCameraMicrophone + product_analytic_verticalCameraMount + 
...
model_4 <- lm(formula = gmv ~ TotalInvestment + totalTV + totalDigital + 
                totalSponsorship + totalContentMarketing + totalOnlineMarketing + 
                totalRadio + totalOther + Promotion + 
                totalunits + avgsla + product_analytic_verticalCameraAccessory + 
                product_analytic_verticalCameraBag + product_analytic_verticalCameraBatteryCharger + 
                product_analytic_verticalCameraEyeCup + product_analytic_verticalCameraHousing + 
                product_analytic_verticalCameraMicrophone + product_analytic_verticalCameraMount + 
...
model_6 <- lm(formula = gmv ~ totalTV + totalDigital + 
                totalSponsorship + totalContentMarketing + totalOnlineMarketing + 
                totalRadio + totalOther + Promotion + 
                avgsla + product_analytic_verticalCameraAccessory + 
                product_analytic_verticalCameraBag + product_analytic_verticalCameraBatteryCharger + 
                product_analytic_verticalCameraEyeCup + product_analytic_verticalCameraHousing + 
                product_analytic_verticalCameraMicrophone + product_analytic_verticalCameraMount + 
                product_analytic_verticalCameraRemoteControl + product_analytic_verticalCameraTripod + 
...
model_8 <- lm(formula = gmv ~ totalTV + totalDigital + 
                totalSponsorship + totalOnlineMarketing + 
                totalOther + Promotion + 
                avgsla + product_analytic_verticalCameraAccessory + 
                product_analytic_verticalCameraBag + product_analytic_verticalCameraBatteryCharger + 
                product_analytic_verticalCameraEyeCup + product_analytic_verticalCameraHousing + 
...
model_9 <- lm(formula = gmv ~ totalTV + totalDigital + 
                ...
                product_analytic_verticalFlash + product_analytic_verticalLens + 
                product_analytic_verticalReflectorUmbrella + product_analytic_verticalStrap + 
                product_analytic_verticalTelescope + avgNPSScore + totalorder_payment_typePrepaid, data = train_camAcces)
summary(model_9)
vif(model_9)

# Removing totalSponsorship  for high vif
...
# Removing totalTV
model_11 <- lm(formula = gmv ~ totalDigital + 
                 totalOnlineMarketing + 
                 totalOther + Promotion + 
                 avgsla + product_analytic_verticalCameraAccessory + 
                 product_analytic_verticalCameraBag + product_analytic_verticalCameraBatteryCharger + 
...
# Removing avgsla
model_12 <- lm(formula = gmv ~ totalDigital + 
                 totalOnlineMarketing + 
                 totalOther + Promotion + 
...
model_13 <- lm(formula = gmv ~ totalOnlineMarketing + 
                 totalOther + Promotion + 
                 product_analytic_verticalCameraAccessory + 
                 product_analytic_verticalCameraBag + product_analytic_verticalCameraBatteryCharger + 
                 product_analytic_verticalCameraEyeCup + product_analytic_verticalCameraHousing + 
...
# Removing product_analytic_verticalReflectorUmbrella
...
model_16 <- lm(formula = gmv ~ totalOnlineMarketing + 
                 totalOther + product_analytic_verticalCameraAccessory + 
                 product_analytic_verticalCameraBag + product_analytic_verticalCameraBatteryCharger + 
                 product_analytic_verticalCameraEyeCup + product_analytic_verticalCameraHousing + 
                 product_analytic_verticalCameraMicrophone + product_analytic_verticalCameraMount + 
                 product_analytic_verticalCameraRemoteControl + product_analytic_verticalCameraTripod + 
...
model_22 <- lm(formula = gmv ~ totalOnlineMarketing + 
                 totalOther + product_analytic_verticalCameraAccessory + 
                 product_analytic_verticalCameraBag + 
                 product_analytic_verticalCameraEyeCup + 
                 product_analytic_verticalCameraRemoteControl + 
                 product_analytic_verticalExtensionTube + product_analytic_verticalFilter + 
                 product_analytic_verticalFlash + product_analytic_verticalLens + 
...
model_25 <- lm(formula = gmv ~ totalOnlineMarketing + 
                 totalOther + product_analytic_verticalCameraAccessory + 
                 product_analytic_verticalCameraBag + 
                 product_analytic_verticalCameraRemoteControl + 
                 product_analytic_verticalFilter + 
...
model_26 <- lm(formula = gmv ~ totalOnlineMarketing + 
                 totalOther + product_analytic_verticalCameraAccessory + 
                 product_analytic_verticalCameraBag + 
                 product_analytic_verticalCameraRemoteControl + 
                 product_analytic_verticalFlash + product_analytic_verticalLens + 
...
model_27 <- lm(formula = gmv ~ totalOnlineMarketing + 
                 totalOther + 
                 product_analytic_verticalCameraBag + 
                 product_analytic_verticalCameraRemoteControl + 
                 product_analytic_verticalFlash + product_analytic_verticalLens + 
...
model_28 <- lm(formula = gmv ~ totalOnlineMarketing + 
                 totalOther + 
                 product_analytic_verticalCameraBag + 
                 product_analytic_verticalCameraRemoteControl + 
...
model_29 <- lm(formula = gmv ~ totalOnlineMarketing + 
                 totalOther + 
                 product_analytic_verticalCameraBag + 
                 product_analytic_verticalLens + 
                 totalorder_payment_typePrepaid, data = train_camAcces)
...
Final_CameraAcc_model <- model_29
...
rsquared
# rsquared = 0.8269168
round(accuracy(test_camAcces$predict_gmv,test_camAcces$gmv),3)
########################################################################################
...
model_2 <- lm(formula = gmv ~ TotalInvestment + totalTV + totalDigital + 
                totalSponsorship + totalContentMarketing + totalSEM + totalRadio + 
                avgmrp + Sold_price + Promotion + totalunits + avgsla + product_analytic_verticalGamePad + 
                ...
                week + totalItemTypeMassMarket, data = train_gameAcces)
summary(model_2)
vif(model_2)

# Removing totalSEM for high vif
model_3 <- lm(formula = gmv ~ TotalInvestment + totalTV + totalDigital + 
                totalSponsorship + totalContentMarketing + totalRadio + 
                avgmrp + Sold_price + Promotion + totalunits + avgsla + product_analytic_verticalGamePad + 
                product_analytic_verticalGamingAccessoryKit + product_analytic_verticalGamingAdapter + 
                product_analytic_verticalGamingHeadset + product_analytic_verticalGamingKeyboard + 
                product_analytic_verticalGamingMemoryCard + product_analytic_verticalGamingMouse + 
...
model_5 <- lm(formula = gmv ~ totalTV + totalDigital + 
                totalSponsorship + totalContentMarketing + totalRadio + 
                avgmrp + Sold_price + Promotion + avgsla + product_analytic_verticalGamePad + 
                product_analytic_verticalGamingAccessoryKit + product_analytic_verticalGamingAdapter + 
                product_analytic_verticalGamingHeadset + product_analytic_verticalGamingKeyboard + 
                product_analytic_verticalGamingMemoryCard + product_analytic_verticalGamingMouse + 
                product_analytic_verticalGamingMousePad + product_analytic_verticalJoystickGamingWheel + 
...
# Removing totalDigital
model_6 <- lm(formula = gmv ~ totalTV +  
                totalSponsorship + totalContentMarketing + totalRadio + 
                avgmrp + Sold_price + Promotion + avgsla + product_analytic_verticalGamePad + 
                product_analytic_verticalGamingAccessoryKit + product_analytic_verticalGamingAdapter + 
                product_analytic_verticalGamingHeadset + product_analytic_verticalGamingKeyboard + 
...
model_7 <- lm(formula = gmv ~ totalTV +  
...
model_8 <- lm(formula = gmv ~ totalTV +  
                totalContentMarketing + totalRadio + 
                avgmrp + Sold_price + Promotion + avgsla + product_analytic_verticalGamePad + 
                product_analytic_verticalGamingAccessoryKit + product_analytic_verticalGamingAdapter + 
                product_analytic_verticalGamingHeadset + product_analytic_verticalGamingKeyboard + 
...
model_9 <- lm(formula = gmv ~ totalTV +  
                totalContentMarketing + totalRadio + 
                avgmrp + Sold_price + Promotion + avgsla + product_analytic_verticalGamePad + 
                product_analytic_verticalGamingAccessoryKit + product_analytic_verticalGamingAdapter + 
                product_analytic_verticalGamingHeadset + product_analytic_verticalGamingKeyboard + 
...
# Removing Sold_price
model_10 <- lm(formula = gmv ~ totalTV +  
                 totalContentMarketing + totalRadio + 
                 avgmrp + Promotion + avgsla + product_analytic_verticalGamePad + 
                 product_analytic_verticalGamingAccessoryKit + product_analytic_verticalGamingAdapter + 
                 product_analytic_verticalGamingHeadset + product_analytic_verticalGamingKeyboard + 
                 product_analytic_verticalGamingMemoryCard + product_analytic_verticalGamingMouse + 
                 product_analytic_verticalJoystickGamingWheel + 
...
# Removing avgsla
model_11 <- lm(formula = gmv ~ totalTV +  
                 totalContentMarketing + totalRadio + 
                 avgmrp + Promotion + product_analytic_verticalGamePad + 
                 product_analytic_verticalGamingAccessoryKit + product_analytic_verticalGamingAdapter + 
                 product_analytic_verticalGamingHeadset + product_analytic_verticalGamingKeyboard + 
                 product_analytic_verticalGamingMemoryCard + product_analytic_verticalGamingMouse + 
                 product_analytic_verticalJoystickGamingWheel + 
...
model_12 <- lm(formula = gmv ~ totalTV +  
                 totalContentMarketing + totalRadio + 
                 avgmrp + product_analytic_verticalGamePad + 
                 product_analytic_verticalGamingAccessoryKit + product_analytic_verticalGamingAdapter + 
                 product_analytic_verticalGamingHeadset + product_analytic_verticalGamingKeyboard + 
                 product_analytic_verticalGamingMemoryCard + product_analytic_verticalGamingMouse + 
                 product_analytic_verticalJoystickGamingWheel + 
...
model_14 <- lm(formula = gmv ~ totalTV +  
                 totalContentMarketing + totalRadio + 
                 avgmrp + product_analytic_verticalGamePad + 
                 product_analytic_verticalGamingAccessoryKit +  
                 product_analytic_verticalGamingHeadset + product_analytic_verticalGamingKeyboard + 
...
model_15 <-  lm(formula = gmv ~ totalTV +  
                  totalContentMarketing + totalRadio + 
                  avgmrp + product_analytic_verticalGamePad + 
                  product_analytic_verticalGamingAccessoryKit +  
                  product_analytic_verticalGamingHeadset + product_analytic_verticalGamingKeyboard + 
...
model_16 <- lm(formula = gmv ~ totalTV +  
                 totalContentMarketing + totalRadio + 
                 avgmrp + product_analytic_verticalGamePad + 
                 product_analytic_verticalGamingHeadset + product_analytic_verticalGamingKeyboard + 
                 product_analytic_verticalGamingMouse + 
...
rsquared
# rsquared = 0.8574194
round(accuracy(test_gameAcces$predict_gmv,test_gameAcces$gmv),3)
########################################################################################
...
model_2 <- lm(formula = gmv ~ TotalInvestment + totalTV + totalDigital + 
                ...
                product_analytic_verticalVoiceRecorder + avgNPSScore + totalorder_payment_typePrepaid + 
                totalItemTypeMassMarket, data = train_homeAudio)
summary(model_2)
vif(model_2)
...
model_3 <- lm(formula = gmv ~ TotalInvestment + totalTV + totalDigital + 
                totalSponsorship + totalContentMarketing + totalOnlineMarketing + 
                totalAffiliates + totalOther + Sold_price + totalunits + 
                product_analytic_verticalDockingStation + product_analytic_verticalFMRadio + 
                product_analytic_verticalHiFiSystem + product_analytic_verticalHomeAudioSpeaker + 
                product_analytic_verticalVoiceRecorder + avgNPSScore + totalorder_payment_typePrepaid + 
                totalItemTypeMassMarket, data = train_homeAudio)
...
# Removing TotalInvestment for high vif value 
model_4 <- lm(formula = gmv ~ totalTV + totalDigital + 
                totalSponsorship + totalContentMarketing + totalOnlineMarketing + 
                totalAffiliates + totalOther + Sold_price + totalunits + 
                product_analytic_verticalDockingStation + product_analytic_verticalFMRadio + 
...
model_10 <- lm(formula = gmv ~ totalTV + totalDigital + 
                 ...
                 product_analytic_verticalDockingStation + product_analytic_verticalFMRadio + 
                 product_analytic_verticalHiFiSystem + product_analytic_verticalHomeAudioSpeaker + 
                 product_analytic_verticalVoiceRecorder + avgNPSScore + totalorder_payment_typePrepaid, data = train_homeAudio)
summary(model_10)
vif(model_10)
...
# Removing product_analytic_verticalDockingStation
model_11 <-  lm(formula = gmv ~ totalTV + totalDigital + 
                  totalOther + Sold_price +  
...
# Removing avgNPSScore
model_14 <- lm(formula = gmv ~ totalTV + totalDigital + 
                 totalOther +   
                 product_analytic_verticalFMRadio + 
                 product_analytic_verticalHomeAudioSpeaker + 
                 product_analytic_verticalVoiceRecorder + totalorder_payment_typePrepaid, data = train_homeAudio)
summary(model_14)
vif(model_14)

# Removing product_analytic_verticalVoiceRecorder
model_15 <- lm(formula = gmv ~ totalTV + totalDigital + 
                 totalOther +   
                 product_analytic_verticalFMRadio + 
                 product_analytic_verticalHomeAudioSpeaker + 
...
model_16 <- lm(formula = gmv ~ totalTV + totalDigital + 
                 totalOther +   
                 product_analytic_verticalFMRadio + 
                 product_analytic_verticalHomeAudioSpeaker, data = train_homeAudio)
summary(model_16)
vif(model_16)

# All features have < 5% P Value.
final_HomeAudioAcc_model <- model_16
...
rsquared
# rsquared = 0.9024772
round(accuracy(test_homeAudio$predict_gmv,test_homeAudio$gmv),3)
...
model_2 <- lm(formula = gmv ~ TotalInvestment + totalTV + totalDigital + 
                ...
                Sold_price + Promotion + totalunits + avgsla + product_analytic_verticalCameraAccessory + 
                ...
                product_analytic_verticalCameraFilmRolls + product_analytic_verticalCameraHousing + 
                product_analytic_verticalCameraMicrophone + product_analytic_verticalCameraMount + 
                ...
                product_analytic_verticalLens + product_analytic_verticalReflectorUmbrella + 
...
model_4 <- lm(formula = gmv ~ TotalInvestment + totalTV + totalDigital + 
                totalSponsorship + totalContentMarketing + 
                totalAffiliates + totalSEM + totalOther + avgmrp + 
                Sold_price + Promotion + totalunits + avgsla + product_analytic_verticalCameraAccessory + 
                product_analytic_verticalCameraBattery + product_analytic_verticalCameraBatteryCharger + 
                product_analytic_verticalCameraBatteryGrip + product_analytic_verticalCameraEyeCup + 
                product_analytic_verticalCameraFilmRolls + product_analytic_verticalCameraHousing + 
...
model_8 <- lm(formula = gmv ~ totalTV + totalDigital + 
                totalSponsorship + totalContentMarketing + 
                totalOther + avgmrp + 
                Sold_price + Promotion + avgsla + product_analytic_verticalCameraAccessory + 
                product_analytic_verticalCameraBattery + product_analytic_verticalCameraBatteryCharger + 
                product_analytic_verticalCameraBatteryGrip + product_analytic_verticalCameraEyeCup + 
                product_analytic_verticalCameraFilmRolls + product_analytic_verticalCameraHousing + 
                product_analytic_verticalCameraMicrophone + product_analytic_verticalCameraMount + 
...
model_13 <- lm(formula = gmv ~ totalTV + totalDigital + 
                 ...
                 product_analytic_verticalCameraBattery +  
                 product_analytic_verticalCameraBatteryGrip + product_analytic_verticalCameraEyeCup + 
                 product_analytic_verticalCameraHousing + 
                 product_analytic_verticalCameraMicrophone + product_analytic_verticalCameraMount + 
                 product_analytic_verticalCameraRemoteControl + product_analytic_verticalExtensionTube + 
                 product_analytic_verticalFlash + 
                 product_analytic_verticalLens + product_analytic_verticalReflectorUmbrella + 
...
model_14 <- lm(formula = gmv ~ totalTV + totalDigital + 
                 totalContentMarketing + 
                 totalOther + 
                 Sold_price + Promotion + product_analytic_verticalCameraAccessory + 
                 product_analytic_verticalCameraBattery +  
                 product_analytic_verticalCameraBatteryGrip + product_analytic_verticalCameraEyeCup + 
                 product_analytic_verticalCameraHousing + 
                 product_analytic_verticalCameraMicrophone + product_analytic_verticalCameraMount + 
...
model_16 <- lm(formula = gmv ~ totalTV + totalDigital + 
                 ...
                 product_analytic_verticalCameraRemoteControl + product_analytic_verticalExtensionTube + 
                 product_analytic_verticalFlash + 
                 product_analytic_verticalReflectorUmbrella + 
                 product_analytic_verticalSoftbox + product_analytic_verticalStrap + 
                 product_analytic_verticalTelescope + week + avgNPSScore + 
                 totalorder_payment_typePrepaid, data = train_camAcces)
summary(model_16)
...
# Removing avgNPSScore 
model_17 <- lm(formula = gmv ~ totalTV + totalDigital + 
                 totalContentMarketing + 
                 totalOther + 
                 Sold_price + Promotion + product_analytic_verticalCameraAccessory + 
                 product_analytic_verticalCameraBatteryGrip + product_analytic_verticalCameraEyeCup + 
                 ...
                 product_analytic_verticalReflectorUmbrella + 
                 product_analytic_verticalSoftbox + product_analytic_verticalStrap + 
                 product_analytic_verticalTelescope + week +  
                 totalorder_payment_typePrepaid, data = train_camAcces)
summary(model_17)
vif(model_17)

# Removing week 
model_18 <- lm(formula = gmv ~ totalTV + totalDigital + 
                 totalContentMarketing + 
                 totalOther + 
                 Sold_price + Promotion + product_analytic_verticalCameraAccessory + 
                 product_analytic_verticalCameraBatteryGrip + product_analytic_verticalCameraEyeCup + 
                 ...
                 product_analytic_verticalReflectorUmbrella + 
                 product_analytic_verticalSoftbox + product_analytic_verticalStrap + 
                 product_analytic_verticalTelescope +   
                 totalorder_payment_typePrepaid, data = train_camAcces)
summary(model_18)
vif(model_18)
...
model_2 <- lm(formula = gmv ~ TotalInvestment + totalTV + totalDigital + 
                ...
                Promotion + totalunits + product_analytic_verticalGameControlMount + 
                product_analytic_verticalGamePad + product_analytic_verticalGamingAccessoryKit + 
                product_analytic_verticalGamingAdapter + product_analytic_verticalGamingHeadset + 
                product_analytic_verticalGamingKeyboard + product_analytic_verticalGamingMemoryCard + 
...
model_3 <- lm(formula = gmv ~ TotalInvestment + totalTV + totalDigital + 
                totalSponsorship + totalContentMarketing + totalOnlineMarketing + 
                totalRadio + totalOther + Sold_price + 
                Promotion + totalunits + product_analytic_verticalGameControlMount + 
                product_analytic_verticalGamePad + product_analytic_verticalGamingAccessoryKit + 
                product_analytic_verticalGamingAdapter + product_analytic_verticalGamingHeadset + 
                product_analytic_verticalGamingKeyboard + product_analytic_verticalGamingMemoryCard + 
...
model_6 <- lm(formula = gmv ~ totalTV + totalDigital + 
                totalSponsorship + totalContentMarketing + totalOnlineMarketing + 
                totalOther + Sold_price + 
                Promotion + product_analytic_verticalGameControlMount + 
                product_analytic_verticalGamePad + product_analytic_verticalGamingAccessoryKit + 
                product_analytic_verticalGamingAdapter + product_analytic_verticalGamingHeadset + 
                product_analytic_verticalGamingKeyboard + product_analytic_verticalGamingMemoryCard + 
                product_analytic_verticalGamingMouse + product_analytic_verticalJoystickGamingWheel + 
...
model_8 <- lm(formula = gmv ~ totalTV + totalDigital + 
                ...
                product_analytic_verticalGamingMouse + product_analytic_verticalJoystickGamingWheel + 
                product_analytic_verticalMotionController + week + avgNPSScore + 
                totalorder_payment_typePrepaid, 
              data = train_gameAcces)
summary(model_8)
vif(model_8)
...
# Removing totalTV
model_10 <- lm(formula = gmv ~ totalDigital + 
                 totalContentMarketing +  
                 totalOther + Sold_price + 
                 Promotion + product_analytic_verticalGameControlMount + 
                 product_analytic_verticalGamePad + product_analytic_verticalGamingAccessoryKit + 
...
model_11 <- lm(formula = gmv ~ totalDigital + 
                 totalContentMarketing +  
                 totalOther + Sold_price + 
                 product_analytic_verticalGameControlMount + 
                 product_analytic_verticalGamePad + product_analytic_verticalGamingAccessoryKit + 
                 product_analytic_verticalGamingAdapter + product_analytic_verticalGamingHeadset + 
                 product_analytic_verticalGamingKeyboard + product_analytic_verticalGamingMemoryCard + 
                 product_analytic_verticalGamingMouse + product_analytic_verticalJoystickGamingWheel + 
...
# Removing avgNPSScore
model_13 <- lm(formula = gmv ~ totalDigital + 
                 totalContentMarketing +  
                 totalOther + Sold_price + 
                 product_analytic_verticalGamePad + product_analytic_verticalGamingAccessoryKit + 
                 product_analytic_verticalGamingAdapter + product_analytic_verticalGamingHeadset + 
...
# Removing week
model_14 <- lm(formula = gmv ~ totalDigital + 
                 totalContentMarketing +  
                 totalOther + Sold_price + 
                 product_analytic_verticalGamePad + product_analytic_verticalGamingAccessoryKit + 
                 product_analytic_verticalGamingAdapter + product_analytic_verticalGamingHeadset + 
...
model_2 <- lm(formula = gmv ~ TotalInvestment + totalTV + totalSponsorship + 
                totalContentMarketing + totalOnlineMarketing + totalAffiliates + 
                totalRadio + totalOther + avgmrp + Sold_price + Promotion + 
                totalunits + product_analytic_verticalDJController + product_analytic_verticalDock + 
                product_analytic_verticalDockingStation + product_analytic_verticalFMRadio + 
                product_analytic_verticalHiFiSystem + product_analytic_verticalHomeAudioSpeaker + 
                product_analytic_verticalSlingBox + avgNPSScore + totalorder_payment_typePrepaid + 
                totalItemTypeMassMarket, data = train_homeAudio)
summary(model_2)
vif(model_2)

# Removing totalAffiliates for high vif 
model_3 <- lm(formula = gmv ~ TotalInvestment + totalTV + totalSponsorship + 
...
# Removing totalOther 
model_4 <- lm(formula = gmv ~ TotalInvestment + totalTV + totalSponsorship + 
                totalContentMarketing + totalOnlineMarketing +  
...
# Removing TotalInvestment
model_5 <- lm(formula = gmv ~ totalTV + totalSponsorship + 
                totalContentMarketing + totalOnlineMarketing +  
                totalRadio + avgmrp + Sold_price + Promotion + 
                totalunits + product_analytic_verticalDJController + product_analytic_verticalDock + 
                product_analytic_verticalDockingStation + product_analytic_verticalFMRadio + 
...
# Removing totalOnlineMarketing
model_6 <- lm(formula = gmv ~ totalTV + totalSponsorship + 
                totalContentMarketing +   
                totalRadio + avgmrp + Sold_price + Promotion + 
                totalunits + product_analytic_verticalDJController + product_analytic_verticalDock + 
                product_analytic_verticalDockingStation + product_analytic_verticalFMRadio + 
...
# Removing Sold_price
model_7 <- lm(formula = gmv ~ totalTV + totalSponsorship + 
                totalContentMarketing +   
...
# Removing totalunits
model_8 <- lm(formula = gmv ~ totalTV + totalSponsorship + 
                totalContentMarketing +   
                totalRadio + avgmrp + Promotion + 
...
model_9 <- lm(formula = gmv ~ totalTV + totalSponsorship + 
                ...
                product_analytic_verticalDockingStation + product_analytic_verticalFMRadio + 
                product_analytic_verticalHiFiSystem + product_analytic_verticalHomeAudioSpeaker + 
                product_analytic_verticalSlingBox + avgNPSScore + totalorder_payment_typePrepaid, data = train_homeAudio)
summary(model_9)
vif(model_9)

# Removing totalTV
model_10 <- lm(formula = gmv ~ totalSponsorship + 
                 totalContentMarketing +   
                 totalRadio + avgmrp + Promotion + 
                 product_analytic_verticalDJController + product_analytic_verticalDock + 
                 product_analytic_verticalDockingStation + product_analytic_verticalFMRadio + 
...
model_11 <- lm(formula = gmv ~ totalSponsorship + 
                 totalContentMarketing +   
                 totalRadio + avgmrp + Promotion + 
...
# Removing Promotion
model_12 <- lm(formula = gmv ~ totalSponsorship + 
                 totalContentMarketing +   
                 totalRadio + avgmrp +  
                 product_analytic_verticalDock + 
                 product_analytic_verticalDockingStation + product_analytic_verticalFMRadio + 
...
model_13 <- lm(formula = gmv ~ totalSponsorship + 
                 totalContentMarketing +   
                 totalRadio + avgmrp +  
                 product_analytic_verticalDock + 
                 product_analytic_verticalDockingStation +  
                 product_analytic_verticalHiFiSystem + product_analytic_verticalHomeAudioSpeaker + 
                 product_analytic_verticalSlingBox + avgNPSScore + totalorder_payment_typePrepaid, data = train_homeAudio)
summary(model_13)
vif(model_13)
...
model_14 <- m(formula = gmv ~ totalSponsorship + 
                totalContentMarketing +   
                totalRadio + avgmrp +  
                product_analytic_verticalDock + 
                product_analytic_verticalDockingStation +  
...
model_1 <- lm(gmv~avgmrp+Sold_price+Promotion+totalunits+avgsla+avgNPSScore+totalorder_payment_typePrepaid+totalItemTypeMassMarket,CameraAccessory_Grouped) 
summary(model_1)
...
model_1 <- lm(gmv~avgmrp+Sold_price+Promotion+totalunits+avgsla+avgNPSScore+totalorder_payment_typePrepaid+totalItemTypeMassMarket,GamingAccessory_Grouped) 
summary(model_1)
...
model_1 <- lm(gmv~avgmrp+Sold_price+Promotion+totalunits+avgsla+avgNPSScore+totalorder_payment_typePrepaid+totalItemTypeMassMarket,HomeAudio_Grouped) 
summary(model_1)
